    ...
    <footer className=" text-center mt-11 text-white bg-gray-600 ">
      <div className="footer w-11/12 m-auto flex flex-col md:flex-row  pt-3 justify-between" >
        <div className="foot text-start md:w-1/2">
          ...
          <p>
            Nursing Times was started by MSN, to encourage graduate nurses. We decided to start a blog that focuses on providing concise,information to help new nurses gain confidence in their abilities. It focuses on nursing education for all nurses.
          </p>
        </div>
