  ...
  return (
    <>
      ...
      <div className="main pb-14">
        ...
        <div className="personal pt-10 bg-yellow-200 pb-10">

          <h1 className='font-bold text-xl pl-48'>Collecting Personal Information</h1>
          <p className='pl-48 text-lg'> Together with the Nursing Times Publishing Co our site provide up-to-date health care information, we are the Nursing Times Group. Some of this information is provided by, and personally identifies, you for example name, email address and bank details. We also collect information from the Nursing Times Group services you’ve used. For example, searching our websites, signing up to an event or clicking an online advert. This helps us to find out what information is important to you so that we can improve the services we offer.</p>

          <h1 className='font-bold text-xl pl-48 pt-4'>Using Your Personal Information</h1>
          <p className='pl-48 text-lg pb-2'>We use the information you provide us to deliver, tailor and improve our services.We only keep your information for as long as you have a relationship with us and where there is a legitimate reason to do so. We may contact applicants who are successful in applying for one of our grants about opportunities to promote the Nursing Times Foundation.</p>
